...
genome=Cni.v2.hic.chr.fasta #genome sequence (fasta file or fasta embeded in GFF3 file)
...
est=all.cdhit.EST.fasta #set of ESTs or assembled mRNA-seq in fasta format
altest= #EST/cDNA sequence file in fasta format from an alternate organism
est_gff= #aligned ESTs or mRNA-seq from an external GFF3 file
altest_gff= #aligned ESTs from a closly relate species in GFF3 format

#-----Protein Homology Evidence (for best results provide a file for at least one)
protein=proteins.cdhit.fasta  #protein sequence file in fasta format (i.e. from mutiple organisms)
protein_gff=  #aligned protein homology evidence from an external GFF3 file

#-----Repeat Masking (leave values blank to skip repeat masking)
model_org= #select a model organism for RepBase masking in RepeatMasker
rmlib=liblist.txt.panTE.fa #provide an organism specific repeat library in fasta format for RepeatMasker
...
augustus_species=Crassostrea_nippona.p #Augustus gene prediction species model
